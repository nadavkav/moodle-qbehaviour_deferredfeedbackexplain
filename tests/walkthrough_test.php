 ...
 *
 * @package    qbehaviour
 * @subpackage deferredfeedbackonlyflagged
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_deferredfeedbackonlyflagged_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedbackonlyflagged_feedback_truefalse() {

        // Create a true-false question with correct answer true.
        $tf = test_question_maker::make_question('truefalse', 'true');
        $this->start_attempt_at_question($tf, 'deferredfeedbackonlyflagged', 2);
    ...
    public function test_deferredfeedbackonlyflagged_feedback_multichoice_single() {

        // Create a true-false question with correct answer true.
        $mc = test_question_maker::make_a_multichoice_single_question();
        $this->start_attempt_at_question($mc, 'deferredfeedbackonlyflagged', 3);
    ...
    public function test_deferredfeedbackonlyflagged_resume_multichoice_single() {
        ...
        // Reinitialise.
        $this->setUp();
        $this->quba->set_preferred_behaviour('deferredfeedbackonlyflagged');
    ...
    public function test_deferredfeedbackonlyflagged_resume_multichoice_single_emptyanswer_first() {
